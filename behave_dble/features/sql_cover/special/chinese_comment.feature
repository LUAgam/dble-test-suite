  ...
  Scenario: #2 case from issue http://10.186.18.11/jira/browse/DBLE0REQ-582
   ...
   Given add xml segment to node with attribute "{'tag':'root'}" in "schema.xml"
    ...
    <schema dataNode="dn1" name="schema1" sqlMaxLimit="100">
       <table name="cl_idx_data_monitor" rule="fixed_uniform_string_rule1" dataNode="dn1,dn2,dn3,dn4" />
       <table name="sys_dict_entry" dataNode="dn1" />
    </schema>
    """
   Given add xml segment to node with attribute "{'tag':'root'}" in "rule.xml"
    """
     <tableRule name="fixed_uniform_string_rule1">
        <rule>
...
#case https://support.actionsky.com/service_desk/browse/ATK-1379
...
#case https://support.actionsky.com/service_desk/browse/ATK-1382
...
#case https://support.actionsky.com/service_desk/browse/ATK-1383
...
#case https://support.actionsky.com/service_desk/browse/ATK-1388
...
#case https://support.actionsky.com/service_desk/browse/ATK-1398
...
##case https://support.actionsky.com/service_desk/browse/ATK-1400
...
#case  https://support.actionsky.com/service_desk/browse/ATK-1403 /ATK-1406  /ATK-1409
    Then execute sql in "dble-1" in "user" mode
      | conn   | toClose  | sql                                        | expect       | db      | charset |
...
#case https://support.actionsky.com/service_desk/browse/ATK-1408
...
#case from github  https://github.com/actiontech/dble/issues/2021
...
#case from github  https://github.com/actiontech/dble/issues/2022
...
#case from github  https://github.com/actiontech/dble/issues/2025
